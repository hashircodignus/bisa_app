  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        actions: [
          TextButton(onPressed: (){}, child: Text("Skip",style: AppTheme.tabText2,))
        ],
      ),
      body: Container(
      ...
      bottomNavigationBar: Padding(
        ...
        child: _image != null ? const ButtonWidget(buttonTextContent: "Submit"): const LightButtonWidget(buttonTextContent: "Submit"),
      ),
    );
  }
}
